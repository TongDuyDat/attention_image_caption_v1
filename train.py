...
def train_epoch(dataloader, encoder, decoder, encode_optim, decode_optim, criterion, device, tokenizer):
    ...
    for i, data in enumerate(tqdm(dataloader)):
        ...
        # score bleu 
        bleu_score_nltk = corpus_bleu(captions_str, decode_pre_str)
...
def train(epochs, batch_size, lr):
    ...
    for epoch in range(epochs):
        ...
        train_loss, bleu_score_train = train_epoch(trainloader, encoder, decoder, encode_optim, decode_optim, criterion, device, tokenizer)
        print ("Train Loss : ", train_loss, end=" ")
        # Validation Phase
        with torch.no_grad():
            valid_loss, bleu_score_val = validate(valloader, encoder, decoder, criterion, device, epoch, tokenizer)
            # Save model
    ...
    testing(testloader, encoder, decoder, tokenizer, device)
